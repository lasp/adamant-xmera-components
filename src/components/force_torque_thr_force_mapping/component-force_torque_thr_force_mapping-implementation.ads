--------------------------------------------------------------------------------
-- Force_Torque_Thr_Force_Mapping Component Implementation Spec
--------------------------------------------------------------------------------
...
package Component.Force_Torque_Thr_Force_Mapping.Implementation is

   -- The component class instance record:
   type Instance is new Force_Torque_Thr_Force_Mapping.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Force_Torque_Thr_Force_Mapping.Base_Instance with record
   ...
   -----------------------------------------------
   -- Description:
   --    Parameters for the Force Torque Thr Force Mapping component
