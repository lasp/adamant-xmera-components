--------------------------------------------------------------------------------
-- Force_Torque_Thr_Force_Mapping Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Force_Torque_Thr_Force_Mapping_Reciprocal;
...
-- Force torque thruster force mapping converts a commanded body force and torque
-- into per-thruster force commands using the truncated-SVD pseudo-inverse of the
-- thruster control mapping matrix.
package Component.Force_Torque_Thr_Force_Mapping.Implementation.Tester is

   use Component.Force_Torque_Thr_Force_Mapping_Reciprocal;
   ...
   type Instance is new Component.Force_Torque_Thr_Force_Mapping_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Force_Torque_Thr_Force_Mapping.Implementation.Instance;
      -- Connector histories:
      ...
      Commanded_Force : Cmd_Force_Body.T;
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Force Torque Thr Force Mapping component.
   -- Thruster force command (8 thrusters)
...
end Component.Force_Torque_Thr_Force_Mapping.Implementation.Tester;
