--------------------------------------------------------------------------------
-- Mrp_Rotation Component Tester Body
--------------------------------------------------------------------------------

-- Includes:
with Parameter;

package body Component.Mrp_Rotation.Implementation.Tester is
   ...
   begin
      ...
      if Id_To_Return = 0 then
         case Arg.Id is
            -- ID for Base_Attitude_Reference:
      ...
      if Length_To_Return = 0 then
         case Arg.Id is
            -- Length for Base_Attitude_Reference:
         ...
         case Arg.Id is
            ...
            when 0 =>
               Buffer_To_Return (Buffer_To_Return'First .. Buffer_To_Return'First + Att_Ref.Size_In_Bytes - 1) :=
                  Att_Ref.Serialization.To_Byte_Array (Self.Base_Attitude_Reference);
