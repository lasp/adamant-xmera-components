--------------------------------------------------------------------------------
-- Axis_To_Gimbal_Angles Component Implementation Spec
--------------------------------------------------------------------------------

-- Includes:
with Tick;
with Parameter_Update;
with Axis_To_Gimbal_Angles_Algorithm_C; use Axis_To_Gimbal_Angles_Algorithm_C;
...
package Component.Axis_To_Gimbal_Angles.Implementation is

   -- The component class instance record:
   type Instance is new Axis_To_Gimbal_Angles.Base_Instance with private;

   --------------------------------------------------
   -- Subprogram for implementation init method:
   --------------------------------------------------
   -- Initializes the axis to gimbal angles algorithm with the default parameter
   -- values.
...
private
   ...
   -- The component class instance record:
   type Instance is new Axis_To_Gimbal_Angles.Base_Instance with record
      Alg : Axis_To_Gimbal_Angles_Algorithm_Access := null;
   end record;
