--------------------------------------------------------------------------------
-- Axis_To_Gimbal_Angles Component Tester Body
--------------------------------------------------------------------------------

-- Includes:
with Parameter;

package body Component.Axis_To_Gimbal_Angles.Implementation.Tester is
   ...
   begin
      ...
      Self.Gimbal_Command_History.Init (Depth => 100);
   end Init_Base;
   ...
   begin
      ...
      -- Data product histories:
      Self.Gimbal_Command_History.Destroy;
   end Final_Base;
         ...
         case Arg.Id is
            ...
            when 0 =>
               Buffer_To_Return (Buffer_To_Return'First .. Buffer_To_Return'First + Packed_F32x3.Size_In_Bytes - 1) :=
                  Packed_F32x3.Serialization.To_Byte_Array (Self.Thrust_Direction);
   ...
   -- components.
   overriding procedure Gimbal_Command (Self : in out Instance; Arg : in Axis_To_Gimbal_Angles_Output.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Gimbal_Command_History.Push (Arg);
   end Gimbal_Command;
