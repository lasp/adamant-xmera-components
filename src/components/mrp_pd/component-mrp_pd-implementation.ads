--------------------------------------------------------------------------------
-- Mrp_Pd Component Implementation Spec
--------------------------------------------------------------------------------

-- Includes:
with Tick;
with Parameter_Update;
with Mrp_Pd_Algorithm_C; use Mrp_Pd_Algorithm_C;
...
package Component.Mrp_Pd.Implementation is

   -- The component class instance record:
   type Instance is new Mrp_Pd.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Mrp_Pd.Base_Instance with record
      Alg : Mrp_Pd_Algorithm_Access := null;
   end record;
   ...
   -----------------------------------------------
   -- Description:
   --    Parameters for the Mrp Pd component.
   ...
   -----------------------------------------------
   -- Description:
   --    Data dependencies for the Mrp Pd component.
