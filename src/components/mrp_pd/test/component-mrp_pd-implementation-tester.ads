--------------------------------------------------------------------------------
-- Mrp_Pd Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Mrp_Pd_Reciprocal;
...
-- MRP proportional-derivative attitude control law. Computes the commanded body
-- torque from the attitude and rate tracking errors. Wraps the MrpPDAlgorithm C++
-- algorithm via its C shim.
package Component.Mrp_Pd.Implementation.Tester is

   use Component.Mrp_Pd_Reciprocal;
   ...
   type Instance is new Component.Mrp_Pd_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Mrp_Pd.Implementation.Instance;
      -- Connector histories:
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Mrp Pd component.
   -- Commanded control torque in body frame components.
...
end Component.Mrp_Pd.Implementation.Tester;
