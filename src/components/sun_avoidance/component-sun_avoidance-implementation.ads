--------------------------------------------------------------------------------
-- Sun_Avoidance Component Implementation Spec
--------------------------------------------------------------------------------
...
package Component.Sun_Avoidance.Implementation is

   -- The component class instance record:
   type Instance is new Sun_Avoidance.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Sun_Avoidance.Base_Instance with record
      Alg : Sun_Avoidance_Algorithm_Access := null;
   end record;
