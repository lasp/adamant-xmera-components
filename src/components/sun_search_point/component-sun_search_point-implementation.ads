--------------------------------------------------------------------------------
-- Sun_Search_Point Component Implementation Spec
--------------------------------------------------------------------------------

-- Includes:
with Tick;
with Parameter_Update;
with Sun_Search_Point_Algorithm_C; use Sun_Search_Point_Algorithm_C;
...
package Component.Sun_Search_Point.Implementation is

   -- The component class instance record:
   type Instance is new Sun_Search_Point.Base_Instance with private;
