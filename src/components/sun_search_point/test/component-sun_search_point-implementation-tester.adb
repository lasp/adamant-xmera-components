...
package body Component.Sun_Search_Point.Implementation.Tester is
   ...
   begin
      ...
      Self.Fault_Detected_History.Init (Depth => 100);
   end Init_Base;
   ...
   begin
      ...
      Self.Fault_Detected_History.Destroy;
   end Final_Base;
   ...
   -- was forced.
   overriding procedure Fault_Detected (Self : in out Instance; Arg : in Packed_Boolean.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Fault_Detected_History.Push (Arg);
   end Fault_Detected;
