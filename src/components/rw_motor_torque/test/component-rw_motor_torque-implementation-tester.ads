--------------------------------------------------------------------------------
-- Rw_Motor_Torque Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Rw_Motor_Torque_Reciprocal;
with Printable_History;
with Data_Product_Return.Representation;
with Data_Product_Fetch.Representation;
with Rwa_Torques.Representation;
...
package Component.Rw_Motor_Torque.Implementation.Tester is
   ...
   package Rwa_Torques_T_Recv_Sync_History_Package is new Printable_History (Rwa_Torques.T, Rwa_Torques.Representation.Image);

   -- Component class instance:
   type Instance is new Component.Rw_Motor_Torque_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Rw_Motor_Torque.Implementation.Instance;
      -- Connector histories:
      Data_Product_Fetch_T_Service_History : Data_Product_Fetch_T_Service_History_Package.Instance;
      Rwa_Torques_T_Recv_Sync_History : Rwa_Torques_T_Recv_Sync_History_Package.Instance;
   ...
   -- control.
   overriding procedure Rwa_Torques_T_Recv_Sync (Self : in out Instance; Arg : in Rwa_Torques.T);
