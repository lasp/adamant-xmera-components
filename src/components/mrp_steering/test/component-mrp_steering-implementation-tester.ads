--------------------------------------------------------------------------------
-- Mrp_Steering Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Mrp_Steering_Reciprocal;
...
package Component.Mrp_Steering.Implementation.Tester is

   use Component.Mrp_Steering_Reciprocal;
   ...
   type Instance is new Component.Mrp_Steering_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Mrp_Steering.Implementation.Instance;
      -- Connector histories:
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Mrp Steering component.
...
end Component.Mrp_Steering.Implementation.Tester;
