--------------------------------------------------------------------------------
-- Mrp_Steering Tests Spec
--------------------------------------------------------------------------------

-- This is a unit test suite for the Mrp Steering component
package Mrp_Steering_Tests.Implementation is

   -- Test data and state:
   type Instance is new Mrp_Steering_Tests.Base_Instance with private;
...
private
   ...
   -- Check the feedforward toggle, the saturation gains, and the maximum rate
   -- options against the Python reference model.
   overriding procedure Test_Steering_Law_Variants (Self : in out Instance);
   ...
   -- Test data and state:
   type Instance is new Mrp_Steering_Tests.Base_Instance with record
      null;
   end record;
