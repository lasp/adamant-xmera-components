--------------------------------------------------------------------------------
-- Css_Wls_Est Component Implementation Spec
--------------------------------------------------------------------------------

-- Includes:
with Tick;
with Css_Wls_Est_Algorithm_C; use Css_Wls_Est_Algorithm_C;
...
package Component.Css_Wls_Est.Implementation is

   -- The component class instance record:
   type Instance is new Css_Wls_Est.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Css_Wls_Est.Base_Instance with record
      Alg : Css_Wls_Est_Algorithm_Access := null;
   end record;
   ...
   -----------------------------------------------
   -- Description:
   --    Parameters for the Css Wls Est component
