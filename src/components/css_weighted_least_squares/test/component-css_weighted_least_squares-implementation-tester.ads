...
package Component.Css_Weighted_Least_Squares.Implementation.Tester is
   ...
   package Num_Css_Viewing_Sun_History_Package is new Printable_History (Packed_U32.T, Packed_U32.Representation.Image);
   ...
   type Instance is new Component.Css_Weighted_Least_Squares_Reciprocal.Base_Instance with record
      ...
      Num_Css_Viewing_Sun_History : Num_Css_Viewing_Sun_History_Package.Instance;
   ...
   -- [-] Estimated unit sun heading in body frame components. Zero when no fit was
   -- possible.
   overriding procedure Sun_Heading_B (Self : in out Instance; Arg : in Packed_F32x3.T);
   -- [rad/s] Inertial angular velocity in body frame components, from two successive
   -- headings. Rotation about the sun heading is not observable. Zero until two
   -- headings have been observed.
   overriding procedure Omega_Bn_B (Self : in out Instance; Arg : in Packed_F32x3.T);
   -- [-] Post-fit residuals, one per sensor that contributed, packed into the
   -- leading Num_Css_Viewing_Sun entries. The rest are zero.
   overriding procedure Post_Fit_Residuals (Self : in out Instance; Arg : in Packed_F32x8.T);
   -- [-] Sensors that contributed to the fit this cycle: available, and reading
   -- above the use threshold.
   overriding procedure Num_Css_Viewing_Sun (Self : in out Instance; Arg : in Packed_U32.T);
