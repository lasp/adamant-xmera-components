...
package body Component.Css_Weighted_Least_Squares.Implementation.Tester is
   ...
   begin
      ...
      Self.Num_Css_Viewing_Sun_History.Init (Depth => 100);
   end Init_Base;
   ...
   begin
      ...
      Self.Num_Css_Viewing_Sun_History.Destroy;
   end Final_Base;
   ...
   overriding procedure Num_Css_Viewing_Sun (Self : in out Instance; Arg : in Packed_U32.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Num_Css_Viewing_Sun_History.Push (Arg);
   end Num_Css_Viewing_Sun;
