--------------------------------------------------------------------------------
-- Celestial_Two_Body_Point Component Implementation Spec
--------------------------------------------------------------------------------
...
package Component.Celestial_Two_Body_Point.Implementation is

   -- The component class instance record:
   type Instance is new Celestial_Two_Body_Point.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Celestial_Two_Body_Point.Base_Instance with record
      Alg : Celestial_Two_Body_Point_Algorithm_Access := null;
   end record;
