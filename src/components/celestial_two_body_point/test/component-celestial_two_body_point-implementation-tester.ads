--------------------------------------------------------------------------------
-- Celestial_Two_Body_Point Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Celestial_Two_Body_Point_Reciprocal;
...
-- second axis as close as possible toward a secondary celestial body. When the
-- two bodies are nearly aligned, the orbit normal about the primary body takes
-- the place of the secondary body. Wraps the CelestialTwoBodyPointAlgorithm C++
-- algorithm via its C shim.
package Component.Celestial_Two_Body_Point.Implementation.Tester is

   use Component.Celestial_Two_Body_Point_Reciprocal;
   ...
   type Instance is new Component.Celestial_Two_Body_Point_Reciprocal.Base_Instance with record
      ...
      -- is made.
      Primary_Body_State : Cartesian_State.T;
      Secondary_Body_State : Cartesian_State.T;
...
end Component.Celestial_Two_Body_Point.Implementation.Tester;
