--------------------------------------------------------------------------------
-- Hill_Point Component Implementation Spec
--------------------------------------------------------------------------------
...
-- the spacecraft and primary body inertial states. Wraps the HillPointAlgorithm
-- C++ algorithm via its C shim.
package Component.Hill_Point.Implementation is

   -- The component class instance record:
   type Instance is new Hill_Point.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Hill_Point.Base_Instance with record
      Alg : Hill_Point_Algorithm_Access := null;
   end record;
