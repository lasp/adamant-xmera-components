--------------------------------------------------------------------------------
-- Hill_Point Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Hill_Point_Reciprocal;
...
package Component.Hill_Point.Implementation.Tester is

   use Component.Hill_Point_Reciprocal;
