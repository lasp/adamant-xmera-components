--------------------------------------------------------------------------------
-- Mrp_Feedback Component Implementation Spec
--------------------------------------------------------------------------------

-- Includes:
with Tick;
with Parameter_Update;
with Mrp_Feedback_Algorithm_C; use Mrp_Feedback_Algorithm_C;
...
package Component.Mrp_Feedback.Implementation is

   -- The component class instance record:
   type Instance is new Mrp_Feedback.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Mrp_Feedback.Base_Instance with record
      Alg : Mrp_Feedback_Algorithm_Access := null;
